...
#
# Generated by Vivado on Wed Apr 03 19:55:22 +0800 2019
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Quzard/OneDrive/COA/COA2_FPGA/CPU/CPU_design1/CPU_design1.cache/compile_simlib/activehdl"
  fi
